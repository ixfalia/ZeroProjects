...
InputActions = Property.DeclareEnum("InputActions", ["MoveUp", "MoveDown", "MoveLeft", "MoveRight", "ActivateKey", "GiveKey", "TakeKey", "FireKey", "CheatGhost", "CheatSkipForwards", "CheatSkipBackwards", "DebugMode"])
...
class KeyboardController:
    ...
    def checkKeyboard(self):
        ...
        self.setKeyStatus(InputActions.DebugMode, Keyboard.KeyIsPressed(Keys.F3))
    ...
    def evaluateKeyboard(self):
        ...
        if self.getKeyStatus(InputActions.DebugMode):
            self.GameSession.DispatchEvent("DebugToggle", Zero.ScriptEvent())
            self.GameSession.DispatchEvent("DebugExtremeToggle", Zero.ScriptEvent())
